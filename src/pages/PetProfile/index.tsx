  ...
  const nextProfileActions = hasValidPetContext
    ? [
        ...
        },
        {
          ...
          accent: '#5a78d4',
          onClick: () =>
            Taro.navigateTo({ url: `/pages/PetServiceCenter/index?mode=member&petId=${currentPetId}` }),
        },
        {
          ...
          onClick: () =>
            stats.reminders === 0
              ? Taro.navigateTo({ url: `/pages/AddPetReminder/index?petId=${currentPetId}&date=${today}` })
