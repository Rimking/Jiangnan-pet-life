      ...
      <View className="px-6 pt-4 pb-[120rpx]">
        ...
        <View className="mb-5 rounded-[24rpx] bg-white p-5 shadow-[0_14rpx_30rpx_rgba(0,0,0,0.08)]">
          ...
          <Text className="text-[22rpx] text-[#666] mt-[8rpx] block">
            按月份查看支出、预算差额和分类分布，适合演示日常养宠成本记录。
          </Text>
        </View>
        ...
        {!loggedIn ? (
          <View
            ...
            style={{ boxShadow: PET_UI_SHADOW }}
          >
            <Text className="text-[30rpx] font-semibold text-[#2B2B2B] block">登录后查看花销统计</Text>
            ...
            <View
              ...
              onClick={() =>
                ensureLoggedIn(`/pages/PetExpenseStats/index${preferredPetId ? `?petId=${preferredPetId}` : ''}`)
              }
            >
        ...
        <View className="grid grid-cols-3 gap-3 mb-5">
          ...
          >
            ...
            <Text className="text-[30rpx] font-semibold text-[#2B2B2B] mt-1 block">{summary.count}</Text>
          </View>
          <View
            className="p-4 rounded-[20rpx] border-[3rpx] border-solid border-[#262626] bg-[#F4F4F4]"
            style={{ boxShadow: PET_UI_SHADOW }}
        ...
        <View
          ...
          style={{ boxShadow: PET_UI_SHADOW }}
        >
          <Text className="text-[30rpx] font-semibold text-[#2B2B2B] mb-3 block">月度预算</Text>
          ...
          {budgetAmount > 0 ? (
            ...
            <Text className="text-[22rpx] text-[#7A7A7A] mt-3 block">暂未设置预算，可先录入一个演示金额。</Text>
          )}
          <View
            className="mt-4 h-[72rpx] rounded-[36rpx] bg-[#FFD93B] border-[2rpx] border-solid border-[#262626] flex items-center justify-center"
        ...
        <View
          ...
          style={{ boxShadow: PET_UI_SHADOW }}
        >
          <Text className="text-[30rpx] font-semibold text-[#2B2B2B] mb-3 block">分类占比</Text>
          {summary.byCategory.length ? (
            ...
            <View className="rounded-[16rpx] bg-[#FFFBEA] p-4">
              ...
              {petId ? (
                ...
                >
                  <Text className="text-[24rpx] font-semibold text-[#5D4510]">去补一笔花销</Text>
                </View>
              ) : null}
            </View>
          )}
        ...
        <View
          ...
          style={{ boxShadow: PET_UI_SHADOW }}
        >
          <Text className="text-[30rpx] font-semibold text-[#2B2B2B] mb-3 block">花销明细</Text>
            ...
            monthlyExpenses.map((item) => (
              ...
              >
                <View className="flex-1 pr-4">
                  ...
                  {item.note ? <Text className="text-[20rpx] text-[#9A9A9A] mt-[6rpx] block">{item.note}</Text> : null}
                </View>
                <Text className="text-[26rpx] font-semibold text-[#FF6B6B]">¥{item.amount.toFixed(2)}</Text>
              </View>
            ))
          ) : (
