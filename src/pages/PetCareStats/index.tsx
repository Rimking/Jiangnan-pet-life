...
const PetCareStats = memo(function PetCareStats() {
  ...
  const canRenderCareContent = Boolean(loggedIn && hasValidPetContext);
        ...
        {hasValidPetContext ? (
          <View className="grid grid-cols-2 gap-3 mb-4">
            <View
              ...
              onClick={() =>
                openPetPage(
                  `/pages/AddPetRecord/index?petId=${petId}&date=${today}&mode=care&returnTo=care-stats`
                )
              }
            >
